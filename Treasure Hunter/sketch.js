...
var thornsImg,thorns,treasureImg,treasure,gunImg,gun,bulletImg,bSound,bullet,lock,lock2,lockImg,skullImg,skull;
...
function preload() {
  ...
  treasureImg=loadImage("./Images/chest.png");
